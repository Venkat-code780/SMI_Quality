  ...
  const loadData = async () => {
    try {
      const [plantData, deptData, ZoneData, MachineData, AuditorsData, supervisorsData, toolnumbersdata] = await Promise.all([
        getListItems("Plant", JvisURL, "*", "", "Title eq 'SMI'"),
        getListItems("Department", JvisURL, "Plant/Title,Title", "Plant", "Plant/Title eq 'SMI' and IsActive eq 1"),
        getListItems("Zones", JvisURL, "Plant/Title,Department/Title,Title", "Plant,Department", "Plant/Title eq 'SMI'"),
        getListItems("Machines", JvisURL, "Plant/Title,Department/Title,Zone/Title,Title", "Plant,Department,Zone", "Plant/Title eq 'SMI'"),
        getListItems("LPA Auditors", currentSiteURL, "Title,Id", "", "Is_x0020_Active eq 1"),
        getListItems("Supervisor", JvisURL, "Plant/Title,Title", "Plant", "Plant/Title eq 'SMI'"),
        getListItems("Tool Numbers", JvisURL, "Plant/Title,Title", "Plant", "Plant/Title eq 'SMI'")
      ]);
      setPlants(plantData);
